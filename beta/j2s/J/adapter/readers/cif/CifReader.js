...
var n = 0;
for (var j = 0; j < tokens.length; j++) if ((f[j] = J.adapter.readers.cif.CifReader.centerOpts[Clazz.doubleToInt (("    1    -1   1/2  -1/2 ".indexOf (tokens[j].trim ()) + 1) / 5)]) != 0) n++;
...
"centerOpts", [0, 1, -1.0, 0.5, -0.5],
"centerToks", "    1    -1   1/2  -1/2 ",
